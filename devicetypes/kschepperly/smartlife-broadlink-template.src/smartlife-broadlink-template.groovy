...
preferences {    
	section("Internal Access"){
		input "id_pw", "text", title: "ID & PW for RM Plugin", required: false
		input "internal_ip", "text", title: "IP Address", required: true
		input "internal_port", "text", title: "Port", required: true
		input "internal_on_path", "text", title: "On Path", required: true
		input "internal_off_path", "text", title: "Off Path", required: false
        input "body_data_for_ha", "text", title: "Entity ID of Body Data", required: false
	}
}
...
metadata {
	definition (name: "SmartLife Broadlink Template", namespace: "kschepperly", author: "Keith Schepperly") {
			capability "Switch"
	}
