...
preferences {    
	section("Internal Access"){
        input "broadlink_code", "text", title: "Broadlink Code", required: true
	}
}

metadata {
	definition (name: "SmartLife Broadlink Button", namespace: "kschepperly1", author: "Keith Schepperly") 
    {
	capability "Actuator"
        capability "Switch"
